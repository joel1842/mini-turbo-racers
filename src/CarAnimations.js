...
function Car2Animation() {
    ...
    const [style, animate] = useSpring(()=> ({
        to: async (next, cancel) => {
            ...
            await next({x:745, config: {duration: Car2.speed}})
            ...
            await next({y:345.6, config: {duration: Car2.speed}})
            ...
            await next({x:1090, config: {duration: Car2.speed}})
            ...
            await next({x:1001, y:234.6, rotate:-360, config: {duration: Car2.speed}})
            Car2.lapCount()
            await next({pause: Car2.doneRace})
        },
        from:{x:1001, y:234.6, rotate: 0, config: {duration: Car2.speed}},
        pause: true,
        loop: true,
    }))
...
function Car3Animation() {
    ...
    const [style, animate] = useSpring(()=> ({
        to: async (next, cancel) => {
            ...
            await next({x:757, config: {duration: Car3.speed}})
            await next({x:607, config: {duration: Car3.speed}})
            await next({x:567, y:109, rotate:-135, config: {duration: Car3.speed}})
            await next({x:558, y:299, rotate:-180, config: {duration: Car3.speed}})
            ...
            await next({x:642, y:230, rotate:-315, config: {duration: Car3.speed}})
            await next({x:752, y:193, rotate:-270, config: {duration: Car3.speed}})
            await next({x:882, y:234, rotate:-225, config: {duration: Car3.speed}})
            await next({x:910, y:304, rotate:-180, config: {duration: Car3.speed}})
            ...
            await next({x:917, y:548, rotate:-270, config: {duration: Car3.speed}})
            await next({x:1090, config: {duration: Car3.speed}})
